...
public class EmployeeDaoTest {
	...
	public void test02InsertEmployee() {
		...
		Employee emp = new Employee(1004, "천사", new Title(5), new Employee(1003), 2000000, new Department(1), new Date());
	...
	public void test03UpdateEmployee() {
		...
		Employee emp = new Employee(1004, "천사2", new Title(4), new Employee(1003), 3000000, new Department(1), new Date());
